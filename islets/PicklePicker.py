...
class PicklePicker:
    def __init__(self, pathToRec=None, series=None, appWidth=1500, debug=False, appHeight=1200, showExamine=True):
            ...
            try:
                if pathToRec_ is not None and len(pathToRec_)!=0:
                    ...
                    if  os.path.isdir(analysisFolder):
                        ...
                        series_ = [el for el in subdirs if os.path.isdir(
                            os.path.join(analysisFolder,el)) and el[0]!="."]
                ...
                if path.endswith("pkl"): ####### pickles ################
                    ...
                    feedback += [
                        ...
                        html.Div(children=[
                            ...
                            html.Br(),
                            "duration (h:m:s): "+str(pd.Timedelta(self.regions.time.max(), unit="s")).split()[-1].split(".")[0],
                            html.Br(),
