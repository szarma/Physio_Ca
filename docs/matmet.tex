...
\begin{figure}[t]
    ...
    \begin{minipage}{.49\textwidth}
        {\fontfamily{phv}\selectfont A} \includegraphics[scale=.5,trim=15mm 0 0 0,clip,align=t]{figures/z_score_1.pdf}
    \end{minipage}
    \begin{minipage}{.49\textwidth} 
...
All {\color{red}?} the experiments discussed in this manuscript were recorded on a Leica setup with Hybrid detector in photon counting mode. In this case, our arguments hold with no modification.

\begin{figure}
%  \includegraphics{}
 \caption{Variance $\sigma^2$ vs $\mu$ of 1000 second long regions from ROIs inferred from {\color{red} ElToro)}
\end{figure}
