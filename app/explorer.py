...
buttonStyle = {"font-family":"Courier New","background-color":"navy","display":"inline-block","color":"white","padding":"5px"}
...
def serve_stuff(selected_rows, username, data):
    try:
        ...
        try:
            ...
            out += [html.Div(html.A("open folder", href=hrefFolder, target='_blank'), style=buttonStyle),html.Br()]
        except:
            pass
